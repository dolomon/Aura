...
struct LocalizedStrings {
  ...
  // New strings for weather screens
  const char* wind;
  const char* direction;
  const char* gusts;
  const char* uv_index;
  const char* cloud_cover;
  const char* pollen;
...
static const LocalizedStrings strings_en = {
  ...
  "Dim screen at night",
  // New weather screen strings
  "Wind", "Direction", "Gusts", "UV Index", "Cloud Cover", "Pollen",
  "Air Quality", "Precipitation", "Humidity", "Dew Point",
...
static const LocalizedStrings strings_es = {
  ...
  "Pantalla noche",
  "Viento", "Dirección", "Ráfagas", "Índice UV", "Nubosidad", "Polen",
  "Calidad del aire", "Precipitación", "Humedad", "Punto de rocío",
  "Visibilidad", "Presión", "Amanecer", "Atardecer"
};
...
static const LocalizedStrings strings_de = {
  ...
  "Nacht-Dimmen",
  // Weather strings
  "Wind", "Richtung", "Böen", "UV-Index", "Bewölkung", "Pollen",
  "Luftqualität", "Niederschlag", "Luftfeuchtigkeit", "Taupunkt",
  "Sichtweite", "Luftdruck", "Sonnenaufgang", "Sonnenuntergang"
};
...
static const LocalizedStrings strings_fr = {
  ...
  "Nuit écran",
  // Weather strings
  "Vent", "Direction", "Rafales", "Indice UV", "Couverture nuageuse", "Pollen",
  "Qualité de l'air", "Précipitations", "Humidité", "Point de rosée",
  "Visibilité", "Pression", "Lever du soleil", "Coucher du soleil"
};
...
static const LocalizedStrings strings_tr = {
  ...
  "Gece kısık",
  // Weather strings
  "Rüzgar", "Yön", "Rüzgar", "UV indeksi", "Bulut örtüsü", "Polen",
  "Hava kalitesi", "Yağış", "Nem", "Çiy noktası",
  "Görüş mesafesi", "Basınç", "Gündoğumu", "Gün batımı"
};
...
static const LocalizedStrings strings_sv = {
  ...
  "Nattdämpning",
  // Weather strings
  "Vind", "Riktning", "Vindbyar", "UV-index", "Molntäcke", "Pollen",
  "Luftkvalitet", "Nederbörd", "Luftfuktighet", "Daggpunkt",
  "Sikt", "Lufttryck", "Soluppgång", "Solnedgång"
};
...
static const LocalizedStrings strings_it = {
  ...
  "Schermo notte",
  // Weather strings
  "Vento", "Direzione", "Raffiche", "Indice UV", "Copertura nuvolosa", "Polline",
  "Qualità dell'aria", "Precipitazioni", "Umidità", "Punto di rugiada",
  "Visibilità", "Pressione", "Alba", "Tramonto"
};
